          ...
          <form action="addemployee" method="POST">
             ...
             <div class="mt-5 md:mt-0 md:col-span-2">
                ...
                <div class="px-4 py-5 bg-white sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                  <p><strong>New Employee Details</strong></p><br/>
                   @if ($errors->any())
              ...
              @endif
                  ...
                  <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-4">
                      ...
                      <input class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full" name="last" id="last" type="text" wire:model.defer="state.last" autocomplete="last">
                    </div>
                    ...
                    <div class="col-span-6 sm:col-span-4">
                      ...
                      <input class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full" name="phone" id="phone" type="text" wire:model.defer="state.phone" maxlength="10">
                    </div>
                     <div class="col-span-6 sm:col-span-4">
                      ...
                      <select name="select_company" id="select_company" class="vs__search" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full">
